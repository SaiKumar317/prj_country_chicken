...
> To configure the module as a External Function in Online Sales Orders	
	a) Go to  > Settings in Online Sales Orders Screen > External Functions
		i) On Event => On Authorize
		ii) Module Type => URL
		iii) URL => /country_chicken/onAuthorize.js
		iv) Function Name => onAuthorizeSO
